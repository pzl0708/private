...
import com.example.pzl.wanandroid.app.Constants;
...
public class CommonUtils {
   ...
   /* *//**
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) MyApp.getApplication().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
